...
namespace FragmentServerWV.Helpers
{
    public class TgaDecoder
    {
        public class TgaData
        {
            ...
            public byte[] pixles;
            public byte[] colorDataUntouched;
            ...
            public TgaData(byte[] image)
            {
                ...
                this.colorDataUntouched = new byte[image.Length - TgaHeaderSize];
                
                Array.Copy(image, TgaHeaderSize, this.colorData, 0, this.colorData.Length);
                Array.Copy(image, TgaHeaderSize, this.colorDataUntouched, 0, this.colorDataUntouched.Length);
                // Index color RLE or Full color RLE or Gray RLE
                if (this.imageType == 9 || this.imageType == 10 || this.imageType == 11)
                    this.elements = this.decodeRLE();
            }
            ...
            public byte[] ColorData => this.colorData;
                ...
                if (colorMapType == 0)
                {
                    switch (this.imageType)
                    {
                        ...
                        case 10:
                            ...
                            int dy = ((this.descriptor & 0x20) == 0 ? (this.imageHeight - 1 - y) : y) *
                                     (this.imageWidth * elementCount);
