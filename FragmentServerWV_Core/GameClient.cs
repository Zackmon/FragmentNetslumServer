    ...
    public class GameClient
    {
        ...
        public void HandlerPacket30(byte[] data, int index, Crypto crypto,byte[] encryptedData)
        {
            ...
            switch (code)
            {
                ...
                case OpCodes.OPCODE_DATA_MAIL_GET:
                    ...
                    SendPacket30(OpCodes.OPCODE_DATA_MAIL_GETOK, new byte[] {0x00, 0x00 , 0x00 , 0x02});
                    
                    // iterate through the mails 
                    SendPacket30(OpCodes.OPCODE_DATA_MAIL_GET_NEWMAIL_HEADER, CreateFakeMailHeader(1));
                    SendPacket30(OpCodes.OPCODE_DATA_MAIL_GET_NEWMAIL_HEADER, CreateFakeMailHeader(2));
                    break;
                case OpCodes.OPCODE_DATA_MAIL_GET_MAIL_BODY:
                    //byte[] fakeMail = CreateFakeMail();
                    // Log.LogData(fakeMail,0xFFFF,this.index,"Fake Mail Data",0,0);
                    Log.LogData(argument, 0xFFFF, this.index, "MAIL CHECK OK", 0, 0);
                    uint Mailid = swap32(BitConverter.ToUInt32(argument, 4));
                    Console.WriteLine("Mail ID " + Mailid);
                    //SendPacket30(OpCodes.OPCODE_DATA_MAIL_GET_MAIL_BODY_RESPONSE, CreateFakeMailHeader(5));
                    //SendPacket30(OpCodes.OPCODE_DATA_MAIL_GET_MAIL_BODY_RESPONSE, new byte[]{0x00,0x01});

                    if (Mailid ==1)
                        SendPacket30(OpCodes.OPCODE_DATA_MAIL_GET_MAIL_BODY_RESPONSE, CreateFakeMail(1));
                    
                    if(Mailid == 2)
                        SendPacket30(OpCodes.OPCODE_DATA_MAIL_GET_MAIL_BODY_RESPONSE, CreateFakeMail(2));
                    

                    //SendPacket30(OpCodes.OPCODE_DATA_MAIL_GET_MAIL_BODY_RESPONSE, CreateFakeMail(3));
                    break;
                ...
                case OpCodes.OPCODE_DATA_MAILCHECK:
                    ...
                    if (mailCount == 0)
                        ...
                        SendPacket30(OpCodes.OPCODE_DATA_MAILCHECK_OK, new byte[] {0x00, 0x00,0x02,0x00});
                    else
                        SendPacket30(OpCodes.OPCODE_DATA_MAILCHECK_OK, new byte[] {0x00, 0x00,0x00,0x00});
        ...
        public void ExtractMailData(byte[] data,byte[] extra, byte[] encrypyedData)
        {
           ...
           Buffer.BlockCopy(extra,0,smthn3,encrypyedData.Length - extra.Length,extra.Length);
            ...
            Console.WriteLine("unknown " + _encoding.GetString(unknown));
            Console.WriteLine("reciver " +_encoding.GetString(reciver));
            Console.WriteLine("sender " + _encoding.GetString(sender));
            Console.WriteLine("title " + _encoding.GetString(title));
            Console.WriteLine("body " + _encoding.GetString(body));
            Console.WriteLine("face " + _encoding.GetString(face));
            Console.WriteLine("smthn1 " +_encoding.GetString(smthn1));
            Console.WriteLine("smthn2 " + _encoding.GetString(smthn2));
            Console.WriteLine("one_p_two " + _encoding.GetString(one_p_two));
            Console.WriteLine("smthn3 " + _encoding.GetString(smthn3));
        ...
        public byte[] CreateFakeMailHeader(uint messageid)
        {
            ;
            
            List<byte> messageID = BitConverter.GetBytes(swap32(messageid)).ToList();
           
            
            List<byte> sender = _encoding.GetBytes("PS3").ToList();
            ...
            List<byte> receiver = _encoding.GetBytes("ZACKMON").ToList();
            while (receiver.Count<18)
            {
                receiver.Add(0x00);
            }
            List<byte> accountID = BitConverter.GetBytes(swap32(6616)).ToList();
           
            
            List<byte> RECaccountID = BitConverter.GetBytes(swap32(55828740)).ToList();

            List<byte> title;
            if (messageid == 1)
                title = _encoding.GetBytes("First Mail").ToList();
            else
                title = _encoding.GetBytes("Second Mail").ToList();

            while (title.Count<128)
            {
                title.Add(0x00);
            }
        ...
        public byte[] CreateFakeMail(uint messageid)
        {
            

            List<byte> face;
            if (messageid == 1)
                face = _encoding.GetBytes("#VER = 0 #FACE = 17665").ToList();
            else
                face = _encoding.GetBytes("#VER = 0 #FACE = 17664").ToList();
            ...
            //byte[] hardBody = {};
            List<byte> body;
            if (messageid == 1 )
                body= _encoding.GetBytes(" this is a test mail Body ").ToList();
            else
                body= _encoding.GetBytes(" Second Body").ToList();
