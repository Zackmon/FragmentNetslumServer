...
namespace FragmentNetslumServer.Services
{
    public class NewsService : INewsService
    {
        ...
        {
            List<NewsSectionModel> listOfArticles =  await Task.Run(() =>DBAccess.getInstance().GetNewsArticles());
...
;                   article.ImageDetails = null;
        ...
        public async Task<List<NewsSectionModel>> GetNewsArticles(string saveId)
        {
            ...
            List<ushort> listOfReadArticles =  await Task.Run(() =>DBAccess.getInstance().GetNewsLog(saveId));
        ...
        {
            await Task.Run(() =>DBAccess.getInstance().UpdateNewsLog(saveId,articleId));
        }
